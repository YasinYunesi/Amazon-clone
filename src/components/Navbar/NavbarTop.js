      ...
      <div className='flex items-center flex-grow'>
        ...
        <div className='hidden mx-5 lg:flex lg:items-end'>
          ...
          <h1 className='text-white text-xs'>
            Deliver to <br />
            <span className='font-extrabold'>United States</span>
          </h1>
        </div>
        ...
        <form className='ml-5 md:mr-5 lg:ml-0 bg-white rounded flex items-center flex-grow'>
          ...
          <div className='inline-block relative group'>
            ...
            <ul className='group-focus-within:block absolute hidden bg-white border border-black z-20'>
              <Link to='/category/electronics' className='dropdown_item'>
                <RouterIcon className='mr-2' />
                Electronics
              </Link>
              <Link to='/category/jewelery' className='dropdown_item'>
                <DiamondIcon className='mr-2' /> Jewelery
              </Link>
              <Link to='/category/mens-clothing' className='dropdown_item'>
                <ManIcon className='mr-2' />
                Men's Clothing
              </Link>
              <Link to='/category/womens-clothing' className='dropdown_item'>
